...
import (
	...
	externalversions "github.com/mattmoor/vmware-sources/pkg/client/informers/externalversions"
	client "github.com/mattmoor/vmware-sources/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/mattmoor/vmware-sources/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
