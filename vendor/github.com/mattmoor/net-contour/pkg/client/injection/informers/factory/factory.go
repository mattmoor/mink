...
import (
	...
	externalversions "github.com/mattmoor/net-contour/pkg/client/informers/externalversions"
	client "github.com/mattmoor/net-contour/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/mattmoor/net-contour/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
