...
import (
	...
	versionedscheme "github.com/vaikas/postgressource/pkg/client/clientset/versioned/scheme"
	injectionclient "github.com/vaikas/postgressource/pkg/client/injection/client"
	postgressource "github.com/vaikas/postgressource/pkg/client/injection/informers/sources/v1alpha1/postgressource"
...
const (
	defaultControllerAgentName = "postgressource-controller"
	defaultFinalizerName       = "postgressources.sources.vaikas.dev"
	defaultQueueName           = "postgressources"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	postgressourceInformer := postgressource.Get(ctx)
	...
	rec := &reconcilerImpl{
		...
		Lister:     postgressourceInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
