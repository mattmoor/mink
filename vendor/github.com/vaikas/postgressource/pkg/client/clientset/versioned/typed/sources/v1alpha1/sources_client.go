...
import (
	...
	"github.com/vaikas/postgressource/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type SourcesV1alpha1Interface interface {
	RESTClient() rest.Interface
	PostgresSourcesGetter
}

// SourcesV1alpha1Client is used to interact with features provided by the sources.vaikas.dev group.
type SourcesV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SourcesV1alpha1Client) PostgresSources(namespace string) PostgresSourceInterface {
	return newPostgresSources(c, namespace)
}
