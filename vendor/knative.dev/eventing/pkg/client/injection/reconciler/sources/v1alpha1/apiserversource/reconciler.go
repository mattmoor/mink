...
// controller finalizing v1alpha1.ApiServerSource.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1alpha1.ApiServerSource. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1alpha1.ApiServerSource) reconciler.Event
}
...
type reconcilerImpl struct {
	...
	Lister sourcesv1alpha1.ApiServerSourceLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister sourcesv1alpha1.ApiServerSourceLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.ApiServerSources(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.ApiServerSource, desired *v1alpha1.ApiServerSource) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.SourcesV1alpha1().ApiServerSources(desired.Namespace)
		...
		updater := r.Client.SourcesV1alpha1().ApiServerSources(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ApiServerSource) (*v1alpha1.ApiServerSource, error) {
	...
	patcher := r.Client.SourcesV1alpha1().ApiServerSources(resource.Namespace)
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1alpha1.ApiServerSource) (*v1alpha1.ApiServerSource, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.ApiServerSource, reconcileEvent reconciler.Event) (*v1alpha1.ApiServerSource, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
