...
require (
	...
	github.com/tektoncd/pipeline v0.18.1-0.20201117015528-719e3042d698
	...
	knative.dev/net-contour v0.19.1-0.20201117015952-a34967dd6a0f
	knative.dev/net-http01 v0.19.1-0.20201117013153-86467bff6159
	knative.dev/networking v0.0.0-20201116165202-57530ee4cbfc
	knative.dev/pkg v0.0.0-20201117020252-ab1a398f669c
	knative.dev/serving v0.19.1-0.20201117021752-3d907356f90a
)
