...
require (
	...
	github.com/sigstore/cosign v1.6.1-0.20220304170544-2e8db229e21f
...
require (
	...
	github.com/google/go-containerregistry/pkg/authn/k8schain v0.0.0-20220219142810-1571d7fdc46e // indirect
